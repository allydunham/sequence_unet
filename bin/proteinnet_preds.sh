...
python bin/predict.py --layers 1 --proteinnet data/proteinnet/casp12/testing models/baseline/freq_classifier/single/model.tf > data/freq/baseline_testing.tsv
python bin/predict.py --layers 1 --proteinnet data/proteinnet/casp12/validation models/baseline/freq_classifier/single/model.tf > data/freq/baseline_validation.tsv
